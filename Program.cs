...
namespace VRChatBioUpdater
{
    ...
    class Program
    {
        ...
        static async Task<TemplateContext> CreateTemplateContext(CurrentUser currentUser)
        {
            ...
            userObj["BioLinks"] = currentUser.BioLinks;
            userObj["Status"] = currentUser.Status;
            userObj["StatusDescription"] = currentUser.StatusDescription;
            userObj["State"] = currentUser.State;
            userObj["Tags"] = currentUser.Tags;
            userObj["DeveloperType"] = currentUser.DeveloperType;
            userObj["LastLogin"] = currentUser.LastLogin;
            ...
            userObj["Friends"] = currentUser.Friends;
