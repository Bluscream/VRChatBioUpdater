...
namespace VRChatBioUpdater
{
    ...
    class Program
    {
        ...
        static async Task<TemplateContext> CreateTemplateContext(CurrentUser currentUser)
        {
            ...
            userObj.Add("Id", currentUser.Id);
            userObj.Add("Username", currentUser.Username);
            userObj.Add("DisplayName", currentUser.DisplayName);
            userObj.Add("UserIcon", currentUser.UserIcon);
            userObj.Add("Bio", currentUser.Bio);
            userObj.Add("BioLinks", currentUser.BioLinks);
            userObj.Add("Status", currentUser.Status);
            userObj.Add("StatusDescription", currentUser.StatusDescription);
            userObj.Add("State", currentUser.State);
            userObj.Add("Tags", currentUser.Tags);
            ...
            userObj.Add("Friends", currentUser.Friends);
